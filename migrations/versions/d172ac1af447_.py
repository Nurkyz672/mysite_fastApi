...
Revision ID: d172ac1af447
Revises: ec09c8826116
Create Date: 2026-02-03 08:59:35.798869
...
revision: str = 'd172ac1af447'
down_revision: Union[str, Sequence[str], None] = 'ec09c8826116'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('sub_category_name', sa.String(length=20), nullable=False),
