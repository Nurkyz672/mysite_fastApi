...
class Category(Base):
    ...
    subcategories : Mapped[List['SubCategory']] = relationship("SubCategory",back_populates=
...
class SubCategory(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    sub_category_name : Mapped[str] = mapped_column(String(20))
...
class Product(Base):
    ...
    article_number : Mapped[int] = mapped_column(Integer,nullable=True)
